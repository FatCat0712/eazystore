...
export default function Header() {
   const navLinkClass = "text-center text-lg font-primary font-semibold text-primary";


    return (
         <header className="border-b border-gray-300 sticky-top top-0 z-20 bg-gray-100">
         <div className="flex items-center justify-between mx-auto max-w-[1152px] px-6 py-4">
                ...
                <nav className="flex items-center py-2 z-10">
                    <ul className="flex space-x-6">
                        <li>
                            <a 
                            href="/" className="text-center text-lg font-primary font-semibold text-primary">
                                Home
                            </a>
                        </li>
                        <li>
