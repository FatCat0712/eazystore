...
//    }
    ...
    public String getUser(@PathVariable(name = "userId") String userId, @PathVariable(name = "postId", required = false) String postId) {
        return "Search for user: " + userId + " and post: " + postId ;
    }
